...
export class LogService {
  ...
  private static staticLogService: LogService;
  public static getInstance(): LogService {
    if (!this.staticLogService) {
      this.staticLogService = new LogService();
    }
    return this.staticLogService;
  }

  public static bindToNamespace(namespace: string): BoundLogger {
    return this.getInstance().bindToNamespace(namespace);
  }
}
